...
export const mockApi = {
  ...
  projects: {
    tasks: (projectId) => withDelay(mockTasks.projectTasks[projectId] || mockTasks.projectTasks.mediqueue || mockTasks.projectTasks["devflow-ai"] || [], 300),
    analytics: (projectId) => withDelay(mockAnalytics.projectAnalytics[projectId] || mockAnalytics.projectAnalytics.mediqueue || null, 400)
  },
  deployments: {
